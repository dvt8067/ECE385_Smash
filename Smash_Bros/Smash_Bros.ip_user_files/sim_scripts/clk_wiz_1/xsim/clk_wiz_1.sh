...
#
# Generated by Vivado on Thu Dec 07 11:48:07 -0600 2023
...
simulate()
{
  xsim  clk_wiz_1 -key {Behavioral:sim_1:Functional:clk_wiz_1} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_ball.protoinst" -log simulate.log
}
