...
HD_PWD='C:/Users/Git_Smash/ECE385_Smash/Smash_Bros/Smash_Bros.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SMASH_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SMASH_TOP.tcl -notrace
