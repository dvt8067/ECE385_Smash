...
logic Mario_Punch_Sucessful, Luigi_Punch_Sucessful, Luigi_Lockout_Count, Mario_Lockout_Count;
...
if((Mario_Topmost_Y == Luigi_Bottommost_Y - 2) || (Mario_Topmost_Y == Luigi_Bottommost_Y- 1) || (Mario_Topmost_Y == Luigi_Bottommost_Y )
        || (Mario_Topmost_Y == Luigi_Bottommost_Y + 1) || (Mario_Topmost_Y == Luigi_Bottommost_Y + 2))  begin
                //Stop_Mario_Up = 1'b1;
...
if((Luigi_Topmost_Y == Mario_Bottommost_Y - 2) || (Luigi_Topmost_Y == Mario_Bottommost_Y - 1) || (Luigi_Topmost_Y == Mario_Bottommost_Y)
        || (Luigi_Topmost_Y == Mario_Bottommost_Y + 1) || (Luigi_Topmost_Y == Mario_Bottommost_Y + 2))begin
                //Stop_Luigi_Up = 1'b1;
...
if((Luigi_Bottommost_Y == Mario_Topmost_Y - 2) || (Luigi_Bottommost_Y == Mario_Topmost_Y- 1) || (Luigi_Bottommost_Y == Mario_Topmost_Y )
        || (Mario_Bottommost_Y == Luigi_Topmost_Y + 1) || (Luigi_Bottommost_Y == Mario_Topmost_Y + 2)) begin
